...
<div class="container-fluid py-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                <h1><b>Thoughtfully selected for lasting quality</b>, With premium materials and hundreds of
                    possibilities, designing your dream bathroom is easy with Block..</h1>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                <p>On average, Block bathrooms are built within 4-6 weeks, compared to the industry
                                    average of 3 months. These 4-6 weeks include demolition, framing, plumbing, tiling,
                                    and electrical work. The exact timeline of your renovation is determined after we
                                    assess your site conditions.</p>
                            </div>
                        </div>
                    </div>
                </div>
